...
<div class="row">
    <div class="col-lg-6 shadow p-4 bg-white m-auto">
        <h3 class="text-center">Tambah Data Barang Keluar</h3>
        <form method="POST" action="/Barang-keluar">
          @csrf
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('petugas') is-invalid @enderror" id="petugas" name="petugas" value="{{ old('petugas') }}">
              @error('petugas')
                  <div class="invalid-feedback">
                    {{ $message }}
                  </div>
